...
public class StockControllerBase
{
    ...
    public static OpenPositionsStockController2 opsc;
    ...
    public static void setUpClass()
    {
        ...
        stockController.getAccountList()
            .clear();
        stockController.getEquityIdList()
            .clear();
        stockController.getStockOpeningList()
            .clear();
        stockController.getStockClosingList()
            .clear();
        stockController.getStockClosedList()
            .clear();
        stockController.getStockClosedTransList()
            .clear();
        stockController.getStockOpenList()
            .clear();
        ...
        CMDBController.executeSQL("delete from hlhtxc5_dmOfx.FIFOOpenTransactions where JoomlaId = " + USER_ID);

        //clear fifoOpenTransactions
        CMDBController.executeSQL("delete from hlhtxc5_dmOfx.FIFOClosedTransactions where JoomlaId = " + USER_ID);
        ...
        CMDBController.executeSQL("delete from hlhtxc5_dmOfx.PositionsOpenTransactions where JoomlaId = " + USER_ID);

        //clear positionsClosedTransactions
        CMDBController.executeSQL("delete from hlhtxc5_dmOfx.PositionsClosedTransactions where JoomlaId = " + USER_ID);
