...
//        this.secId.doSQL(invAcctFrom);
        ...
        String sTable = "hlhtxc5_dbOfx.InvExpense";

        String[] keys =
        {
            "AcctId", "FiTId",
            "SecId", "Total",
            "SubAcctSec", "SubAcctFund", "CurSym",
            "OrigCurSym", "Inv401kSource"
        };
        String[] values =
        {
            invAcctFrom.invAcctId.toString(), this.invTran.fiTId,
            String.valueOf(this.secId.uniqueId), String.valueOf(this.total),
