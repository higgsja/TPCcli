...
public class TDAmeritradeFetchStocksController {
...
//            .build();
        ...
        try {
            ph = TDAmeritradeFetchStocksController.httpTdaClient.priceHistory(request);
            if (ph.isEmpty()) {
...
//                    JOptionPane.ERROR_MESSAGE);
            ...
            TDAmeritradeFetchStocksController.doHistory(symbol, ph);
            TDAmeritradeFetchStocksController.doStockSQL();
